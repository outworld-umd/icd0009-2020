...
```
```
dotnet aspnet-codegenerator controller -name AbsenceReasonController -actions -m AbsenceReason -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name DependenceController -actions -m Dependence -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name DependenceTypeController -actions -m DependenceType -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name FormController -actions -m Form -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name FormRoleController -actions -m FormRole -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name GradeController -actions -m Grade -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name GradeColumnController -actions -m GradeColumn -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name GradeTypeController -actions -m GradeType -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
...
dotnet aspnet-codegenerator controller -name PersonFormController -actions -m PersonForm -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name PersonGroupController -actions -m PersonGroup -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name RemarkController -actions -m Remark -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name RemarkTypeController -actions -m RemarkType -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name SubjectController -actions -m Subject -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
dotnet aspnet-codegenerator controller -name SubjectGroupController -actions -m SubjectGroup -dc AppDbContext -outDir ApiControllers -api --useAsyncActions -f
